...
```
pip install https://github.com/kkollsga/rusty_graph/blob/main/wheels/sheet_excavator-0.1.0-cp312-none-win_amd64.whl?raw=true
# or upgrade an already installed library
pip install --upgrade https://github.com/kkollsga/rusty_graph/blob/main/wheels/sheet_excavator-0.1.0-cp312-none-win_amd64.whl?raw=true
```
